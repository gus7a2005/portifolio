  ...
  return (
    <section id="contato" className="py-20 px-6 bg-gray-900/30">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          <motion.a
            href="mailto:gumorenocoelho@gmail.com"
          ...
          <motion.a
            href="https://www.linkedin.com/in/gustavo-coelho-872ab816a/"
            target="_blank"
          ...
          <motion.a
            href="https://wa.me/5511947286208"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.1, y: -5 }}
            whileTap={{ scale: 0.95 }}
          ...
          <motion.a
            href="https://www.instagram.com/gustavo_mcoelho/"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.1, y: -5 }}
            whileTap={{ scale: 0.95 }}
